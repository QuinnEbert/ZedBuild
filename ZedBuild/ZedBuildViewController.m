...
#import "ZedBuildViewController.h"
...
@interface ZedBuildViewController () {
    GLuint _program;
...
@implementation ZedBuildViewController
...
- (void)setupGL
{
    ...
    self.effect.light0.diffuseColor = GLKVector4Make(1.0f, 0.25f, 0.25f, 1.0f);
...
- (void)update
{
    ...
    GLKMatrix4 projectionMatrix = GLKMatrix4MakePerspective(GLKMathDegreesToRadians(65.0f), aspect, 0.1f, 90.0f);
